package com.example.urzaacademyheadmaster;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void plusOneOnClick(View v){
        int n = randomAbility();
        TextView changingText = findViewById(R.id.abilityText);
        String[] myStringArray
                = {"Until end of turn, up to one target creature gets +1/+1 and gains first strike, vigilance, and lifelink.",//one
                "Distribute three +1/+1 counters among one, two, or three target creatures you control.",//two
                "Destroy target noncreature permanent.",//three
                "Create two 3/1 red Elemental creature tokens with haste. Exile them at the beginning of the next end step.",//four
                "Create three 1/1 white Soldier creature tokens.",//five
                "Create a 3/3 black Beast creature token with deathtouch.",//six
                "Reveal the top five cards of your library. Put all creature cards revealed this way into your hand and the rest on the bottom of your library in any order.",//seven
                "During target opponent’s next turn, creatures that player controls attack Urza if able.",//8
                "Put a loyalty counter on Urza for each creature target opponent controls.",//9
                "Until your next turn, whenever a creature an opponent controls attacks, it gets -1/-0 until end of turn.",//10
                "Target player exiles a card from his or her hand.",//11
                "Reveal the top card of your library. If it’s a land card, put it onto the battlefield. Otherwise, put it into your hand.",//12
                "Target land you control becomes a 4/4 Elemental creature with trample. It’s still a land.",//13
                "Draw a card, then add one mana of any color to your mana pool.",//14
                "Until end of turn, Urza becomes a legendary 4/4 red Dragon creature with flying, indestructible, and haste. (He doesn’t lose loyalty while he’s not a planeswalker.)",//15
                "Until your next turn, creatures you control get +1/+0 and gain lifelink.",//16
                "Look at the top five cards of your library. You may reveal an artifact card from among them and put it into your hand. Put the rest on the bottom of your library in any order.",//17
                "Urza deals 3 damage to target creature or player.",//18
                "Until your next turn,whenever a creature deals combat damage to Urza, destroy that creature.",//19
                "Add X mana in any combination of colors to your mana pool, where X is the number of creatures you control."//20
        };

        changingText.setText(myStringArray[n-1]);

    }
    public void minusOneOnClick(View v){
        TextView changingText = findViewById(R.id.abilityText);
        int n = randomAbility();
        String[] myStringArray
    ...
    public void minusSixOnClick(View v){
        TextView changingText = findViewById(R.id.abilityText);
        int n = randomAbility();
        String[] myStringArray =
