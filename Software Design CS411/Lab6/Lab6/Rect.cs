...
namespace Lab6
{
    public class Rect : Shape
    {
        ...
        public Rect(int x, int y, int x2, int y2, int p, int b, int width, bool fO, bool oO)
        ...
        public override void DrawShape(Graphics g)
        {
            ...
            else
            {
                ...
                if (fillOn == true)
                {
                    ...
                    if (fC == 0)      { brush.Color = Color.White; g.FillRectangle(brush, r); }
                    else if (fC == 1) { brush.Color = Color.Black; g.FillRectangle(brush, r); }
                    else if (fC == 2) { brush.Color = Color.Red;   g.FillRectangle(brush, r); }
                    else if (fC == 3) { brush.Color = Color.Blue;  g.FillRectangle(brush, r); }
                    else if (fC == 4) { brush.Color = Color.Green; g.FillRectangle(brush, r); }
                }
                if(outlineOn == true)
                {
